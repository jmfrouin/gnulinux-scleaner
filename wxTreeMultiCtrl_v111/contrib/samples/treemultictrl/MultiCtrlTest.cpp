       ...
       : wxFrame(NULL, -1, title, pos, size, style)
{
	...
	wxTreeMultiItem item = _tmc->AddRoot(_T("/home/snoogie/Fun/Stuff/"), _T("/home/snoogie/Fun/Stuff"));

	pnl = new wxPanel(_tmc, -1);
	sizer = new wxBoxSizer(wxHORIZONTAL);
	sizer->Add(new wxCheckBox( pnl, ID_CHECK1, _T("test.txt")), 0, wxALL, 2 );
	sizer->Add(new wxStaticText( pnl, ID_CHECK1, _T("102 KB")), 0, wxALL, 2 );
	sizer->Add(new wxStaticBitmap( pnl, ID_CHECK1, mondrian_xpm), 0, wxALL, 2 );
    pnl->SetSizer(sizer);
	...
	pnl = new wxPanel(_tmc, -1);
	sizer = new wxBoxSizer(wxHORIZONTAL);
	sizer->Add(new wxCheckBox( pnl, ID_CHECK1, _T("test2.txt")), 0, wxALL, 2 );
	sizer->Add(new wxStaticText( pnl, ID_CHECK1, _T("96 B")), 0, wxALL, 2 );
	sizer->Add(new wxStaticBitmap( pnl, ID_CHECK1, mondrian_xpm), 0, wxALL, 2 );
    pnl->SetSizer(sizer);
	pnl->SetBackgroundColour(*wxBLUE);
	...
	pnl = new wxPanel(_tmc, -1);
	sizer = new wxBoxSizer(wxHORIZONTAL);
	sizer->Add(new wxButton(pnl, ID_COLLAPSE, _T("All")), 0, wxALL, 2);
	sizer->Add(new wxButton(pnl, ID_COLLAPSE, _T("None")), 0, wxALL, 2);
    pnl->SetSizer(sizer);
	pnl->SetBackgroundColour(*wxWHITE);
	...
	//pnl = new wxPanel(_tmc, -1);
	//sizer = new wxBoxSizer(wxHORIZONTAL);
	//sizer->Add(new wxCheckBox( pnl, -1, _T("Add email addresses to my:")), 0, wxALIGN_CENTER, 0 );
	//sizer->Add(new wxComboBox( pnl, -1, _T("Item1")));
	//
	//pnl->SetSizer(sizer);
	//_tmc->AppendWindow(item, pnl, _T(""), wndinfo);
