...
Plugins::CInPluginInitializer<CreposPlugin> gEmptyFolders;

CreposPlugin::CreposPlugin()
{
  SetName("repos");
}
...
void CreposPlugin::ProcessFile(const std::string& filename)
{
  struct stat Stat;
...
std::string CreposPlugin::Description()
{
  return "Find repository stuff.";
}
